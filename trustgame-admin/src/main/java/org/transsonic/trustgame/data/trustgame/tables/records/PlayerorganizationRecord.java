...
public class PlayerorganizationRecord extends UpdatableRecordImpl<PlayerorganizationRecord> implements Record9<Integer, String, String, Integer, Integer, Integer, Integer, Integer, Integer> {
    ...
    /**
     * Setter for <code>trustgame.playerorganization.TargetProfit</code>.
     */
    ...
    /**
     * Getter for <code>trustgame.playerorganization.TargetProfit</code>.
     */
    ...
    /**
     * Setter for <code>trustgame.playerorganization.TargetSatisfaction</code>.
     */
    ...
    /**
     * Getter for <code>trustgame.playerorganization.TargetSatisfaction</code>.
     */
    ...
    /**
     * Setter for <code>trustgame.playerorganization.TargetSustainability</code>.
     */
    ...
    /**
     * Getter for <code>trustgame.playerorganization.TargetSustainability</code>.
     */
    ...
    @Override
    public PlayerorganizationRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PlayerorganizationRecord(Integer id, String name, String description, Integer targetprofit, Integer targetsatisfaction, Integer targetsustainability, Integer startprofit, Integer startsatisfaction, Integer startsustainability) {
        super(Playerorganization.PLAYERORGANIZATION);
