...
public class Keys {
    ...
    public static final UniqueKey<CarrierRecord> KEY_CARRIER_VNAME_UNIQUE = Internal.createUniqueKey(Carrier.CARRIER, DSL.name("KEY_carrier_Vname_UNIQUE"), new TableField[] { Carrier.CARRIER.VNAME }, true);
    ...
    public static final UniqueKey<ClientRecord> KEY_CLIENT_VNAME_UNIQUE = Internal.createUniqueKey(Client.CLIENT, DSL.name("KEY_client_Vname_UNIQUE"), new TableField[] { Client.CLIENT.VNAME }, true);
    ...
    public static final UniqueKey<GameRecord> KEY_GAME_VERSION_UNIQUE = Internal.createUniqueKey(Game.GAME, DSL.name("KEY_game_Version_UNIQUE"), new TableField[] { Game.GAME.VERSION }, true);
    public static final UniqueKey<GameRecord> KEY_GAME_VNAME_UNIQUE = Internal.createUniqueKey(Game.GAME, DSL.name("KEY_game_Vname_UNIQUE"), new TableField[] { Game.GAME.VNAME }, true);
    ...
    public static final UniqueKey<MissionRecord> KEY_MISSION_VERSION_UNIQUE = Internal.createUniqueKey(Mission.MISSION, DSL.name("KEY_mission_Version_UNIQUE"), new TableField[] { Mission.MISSION.VERSION }, true);
    public static final UniqueKey<MissionRecord> KEY_MISSION_VNAME_UNIQUE = Internal.createUniqueKey(Mission.MISSION, DSL.name("KEY_mission_Vname_UNIQUE"), new TableField[] { Mission.MISSION.VNAME }, true);
    ...
    public static final ForeignKey<GameRecord, MissionRecord> FK_GAME_MISSION1 = Internal.createForeignKey(Game.GAME, DSL.name("fk_Game_Mission1"), new TableField[] { Game.GAME.MISSION_ID }, Keys.KEY_MISSION_PRIMARY, new TableField[] { Mission.MISSION.ID }, true);
