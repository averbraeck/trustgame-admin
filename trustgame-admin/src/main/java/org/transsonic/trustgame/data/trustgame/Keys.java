...
public class Keys {
    ...
    public static final UniqueKey<MissionRecord> KEY_MISSION_NAME_UNIQUE = Internal.createUniqueKey(Mission.MISSION, DSL.name("KEY_mission_Name_UNIQUE"), new TableField[] { Mission.MISSION.NAME }, true);
