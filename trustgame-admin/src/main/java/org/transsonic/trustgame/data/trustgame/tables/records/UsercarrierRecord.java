...
public class UsercarrierRecord extends UpdatableRecordImpl<UsercarrierRecord> implements Record4<Integer, Integer, Integer, Byte> {
    ...
    @Override
    public UsercarrierRecord values(Integer value1, Integer value2, Integer value3, Byte value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsercarrierRecord(Integer id, Integer gameuserId, Integer carrierId, Byte boughtreport) {
        super(Usercarrier.USERCARRIER);
