...
public class Indexes {
    ...
    public static final Index GAME_FK_GAME_MISSION1_IDX = Internal.createIndex(DSL.name("fk_Game_Mission1_idx"), Game.GAME, new OrderField[] { Game.GAME.MISSION_ID }, false);
